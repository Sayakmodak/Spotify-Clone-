...
const songs = [
    {
        id: "1",
        songname: `Agar Tum Sath Hoo<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/1.jpg"
    },
    {
        id: "2",
        songname: `Tu Mera Koi Na Hoke Vi Kuch Lage<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/2.jpg"
    },
    {
        id: "3",
        songname: `Bandeya<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/3.jpg"
    },
    {
        id: "4",
        songname: `Chod Diye<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/4.jpg"
    },
    {
        id: "5",
        songname: `Rang The Noor Tha Jab Karib Tu Tha<br>
        <div class="subtitle">Arijit Singh
        </div>`,
        poster: "Images/arijitI/5.jpg"
    },
    {
        id: "6",
        songname: `Jo Tu Mera Hum Safar<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/6.jpg"
    },
    {
        id: "7",
        songname: `Kesariya<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/7.jpg"
    },
    {
        id: "8",
        songname: `Khamoshiyan<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/8.jpg"
    },
    {
        id: "9",
        songname: `Sansoon Ko<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/9.jpg"
    },
    {
        id: "10",
        songname: `Tum Hi Hoo<br>
        <div class="subtitle">Arijit Singh</div>`,
        poster: "Images/arijitI/10.jpg"
    }
    /*{
        id: "11",
        songname: `Sorry<br>
...
masterPlay.addEventListener("click", function () {
    let currentSong = music.currentSrc; //http://127.0.0.1:5500/Audios/arijitS/1.mp3
    // console.log(music.currentSrc);
    let p = currentSong.split("/arijitS/")[1]; // 7.mp3
...
songItem.forEach((elm) => {
    elm.addEventListener("click", function () {
        ...
        if (songPlayPause.classList.contains("bi-play-circle")) {
            ...
            music.src = `Audios/arijitS/${songId}.mp3`;
            nowPlayingPoster.src = `Images/arijitI/${songId}.jpg`;
            playingSongTitle.innerHTML = songs[songId - 1].songname;
            music_download.href = `Audios/arijitS/${songId}.mp3`;
...
nextSong.addEventListener("click", function () {
    ...
    //console.log((music.currentSrc) + 1);
    if (songId >= 10) {
        songId = 1;
    }
    else {
